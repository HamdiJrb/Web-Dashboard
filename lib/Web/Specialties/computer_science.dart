...
class ComputeScience extends StatefulWidget {
  const ComputeScience({super.key});

  @override
  State<ComputeScience> createState() => _ComputeScienceState();
}

class _ComputeScienceState extends State<ComputeScience> {
